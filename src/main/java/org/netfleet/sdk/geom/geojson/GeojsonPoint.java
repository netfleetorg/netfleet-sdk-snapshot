...
public class GeojsonPoint extends GeojsonGeometry {
  ...
  private GeojsonCoordinate coordinates;

  public GeojsonPoint() {
  }

  public GeojsonPoint(GeojsonCoordinate coordinates) {
    this.coordinates = coordinates;
  }

  public GeojsonPoint(GeojsonCrs crs, GeojsonCoordinate coordinates) {
    this.crs = crs;
    this.coordinates = coordinates;
  }
  ...
  @Override
  public GeojsonCoordinate getCoordinates() {
    return coordinates;
  }

  public void setCoordinates(GeojsonCoordinate coordinates) {
    this.coordinates = coordinates;
  }
}
